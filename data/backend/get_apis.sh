...
do
	...
	wget --header="Accept: text/html" --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0" https://tradeogre.com/api/v1/ticker/BTC-KRB -O /usr/local/nginx/html/api/BTC-KRB.xml
	...
	wget --header="Accept: text/html" --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0" https://tradeogre.com/api/v1/ticker/BTC-XMR -O /usr/local/nginx/html/api/BTC-XMR.xml
	wget --header="Accept: text/html" --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0" https://tradeogre.com/api/v1/ticker/BTC-ARQ -O /usr/local/nginx/html/api/BTC-ARQ.xml
	wget --header="Accept: text/html" --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0" https://tradeogre.com/api/v1/ticker/BTC-WOW -O /usr/local/nginx/html/api/BTC-WOW.xml
